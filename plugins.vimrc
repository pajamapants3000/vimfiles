...
" This plugins file will load all available plugins and settings
...
let PLUGIN_VIM_SESSION = 1
let PLUGIN_VIM_MISC = 1
let PLUGIN_VIM_SHELL = 1
let PLUGIN_AUTOCOMPLPOP = 1
...
let PLUGIN_VIM_EASYOPERATOR_LINE = 1
let PLUGIN_VIM_EASYOPERATOR_PHRASE = 1
...
let PLUGIN_AGIT = 1
let PLUGIN_GIST_VIM = 1
let PLUGIN_VIM_GISTA = 1
let PLUGIN_VIM_GISTA_UNITE = 1
...
let PLUGIN_VIM_ADDON_MW_UTILS = 1
let PLUGIN_TLIB_VIM = 1
let PLUGIN_VIM_SNIPMATE = 1
...
" Lua
let PLUGIN_VIM_LUA_FTPLUGIN = 1
let PLUGIN_LUA_OMNI = 1
let PLUGIN_VIM_LUA_MANUAL = 1

" Python
let PLUGIN_JEDI_VIM = 1
let PLUGIN_PYDOC = 1
let PLUGIN_VIM_VIRTUALENV = 1

" Rust
let PLUGIN_VIM_RACER = 1

" Colorscheme- and Theme-related
let PLUGIN_CSAPPROX = 1
let PLUGIN_VIM_COLORSTEPPER = 1
let PLUGIN_VIM_THEMATIC = 1
let PLUGIN_VIM_FONTZOOM = 1
let PLUGIN_TABPAGECOLORSCHEME = 1

" Colorschemes
let PLUGIN_FLAZZ_VIM_COLORSCHEMES = 1
...
" Doing more with vim!
let PLUGIN_CALENDAR = 1
let PLUGIN_VIM_PAGER = 1
let PLUGIN_VIM_MANPAGER = 1
let PLUGIN_VIMSHELL = 1
let PLUGIN_VIMFILER = 1
let PLUGIN_VS_BROWSER = 1
let PLUGIN_SYNMARK = 1
let PLUGIN_MJBROWNIE_BROWSER = 1
let PLUGIN_VS_WEBBROWSER = 1
